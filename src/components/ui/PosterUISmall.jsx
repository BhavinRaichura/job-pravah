    ...
    <div className=' group flex  w-72   px-2 text-gray-400 hover:text-lime-50  transition-transform   line-clamp-2' title={title}>
        ...
        <div className=' pl-3 w-full '>
          ...
          <Link href={`/blog/${createdAt}/${slug}`}>
            <p className="pb-2 block  text-sm  font-medium leading-snug tracking-normal  antialiased cursor-pointer text-ellipsis overflow-hidden h-16 w-full  line-clamp-2 uppercase"> <span className='line-clamp-3'>{title}</span></p>
          </Link>
