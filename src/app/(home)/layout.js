    ...
    <div className='bg-white'>
        ...
        <div className='  mt-10 py-10 justify-center w-full flex '>
          <div className='  2xl:w-3/5 max-2xl:w-5/6 max-xl:w-11/12 max-lg:w-full lg:flex'>
            <main className=' lg:sticky lg:top-0  h-fit w-2/3 max-lg:w-full overflow-hidden'>
              {children}
            </main>
            <aside className='  w-1/3 max-lg:w-full lg:sticky   h-fit overflow-hidden lg:-top-2/3 ' >
              <Aside/> 
            </aside>
